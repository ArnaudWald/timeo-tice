# -*- coding: utf-8 -*-
from display_utils import pretty_print_ligne, pretty_print_arrets, \
    bounded_int_input, cli_display
from get_passages import get_times
...
def use_case_stop_code(df_stops):
...
def use_case_stop_name(df_stops):
...
def use_case_choose_line(df_stops):
